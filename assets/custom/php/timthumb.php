	...
	public function __construct(){
		...
		if(FILE_CACHE_DIRECTORY){
			...
			if (!touch($this->cacheDirectory . '/index.html')) {
				// $this->error("Could note dd create the ".$this->cacheDirectory."index.html file.");   
			} 
		} else {  
		...
		if($this->isURL){
			...
			/*	$actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
				// echo $actual_link;
				include("../../zAdm/includes/db.php");
				include("../../zAdm/includes/functions.php");
				$conn = db_connect(HOST, USER, PASS, DB, PORT);
				$SQL = "SELECT destino, tipo FROM redirecciones WHERE origen = '$actual_link'"; 
