...
$config["titleadmin"] = "HunterDouglas Online";
$config["logoadmin"] = $config['base_url']."assets/custom/img/logo.png";
$config["logoadmin-white"] = $config['base_url']."assets/custom/img/logo-white.png";

$config["ext_video"] = "|mp4|avi|asf|mov|m4v|wmv"; 
$config["ext_image"] = "|jpg|png|gif|bmp"; 
