      ...
      <div class="page-sidebar">
        <nav class="navbar" role="navigation"> 
          ...
          <ul class="nav navbar-nav margin-bottom-35">
            <li class="active" > <a href="#"> Presentación y Programa </a> </li> 
            <li> <a href="#"> Calendario Academia </a> </li>
            <li> <a href="https://myhd.s1.cl/videos/list"> Videos de academia </a> </li>
          </ul>
        </nav>
      </div>
      <!-- END PAGE SIDEBAR -->
          ...
          <div class="col-md-7 col-xs-12">
            <div class="portlet light portlet-fit">
              <div class="portlet-body font-blue-dark">
                ...
                <h4 class="caption-subject bold">Bienvenido a la Academia HD</h4>
              ...
              <div class="portlet-body font-blue-dark"> <br> <img src="<?php echo base_url(); ?>assets/custom/img/gallery/academia.png"   alt=""/></div></div></div>
        </div>
