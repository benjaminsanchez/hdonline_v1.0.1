      ...
      <div class="page-content-row">
        ...
        <div class="page-content-col">
          <div class="portlet light">
            <form action="<?php echo base_url(); ?>contenidos/guardar-noticia" method="POST" class="form form-horizontal">
              ...
              <div class="row">
                <div class="col-md-9 col-sm-9 light">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9">
                      <input type="hidden" name="imagen_principal" class="form-control grey-silver" readonly> <a href="#" data-url="<?php echo base_url(); ?>biblioteca/list?mode=select&field=imagen_principal" data-toggle="modal" class="btn blue pull-left biblioteca"><i class="fa fa-search"></i> &nbsp;Examinar</a>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9"> <span class="help-inline">desde</span>
                      <input type="text" name="programar_desde" class="form-control input-inline grey-silver input-small date-picker" placeholder="01/08/2016">
                      <span class="help-inline">hasta</span>
                      <input type="text" name="programar_hasta" class="form-control input-inline grey-silver input-small date-picker" placeholder="01/08/2016">
                      <label class="mt-checkbox mt-checkbox-outline"> Borrador
                        <input type="checkbox" value="0" name="estado" class="input-inline" />
                        <span></span> </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9">
                        ...
                        <input type="checkbox" value="1" name="mantener_arriba" />
                        <span></span> </label>
                    </div>
                  </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <textarea class="ckeditor form-control" name="texto" rows="6" data-error-container="#editor2_error"></textarea>
              ...
              <div class="form-group">
                <div class="fileupload-buttonbar col-md-12">
                  <div class="">
                    ...
                    </span> --><a href="javascript:void(0)" class="btn blue biblioteca"  data-url="<?php echo base_url(); ?>biblioteca/list?mode=select_multiple&field=archivos" data-toggle="modal"> <i class="fa fa-plus"></i> <span> Abrir Biblioteca </span> </a>
              ...
              <a href="javascript:void(0)" class="btn blue biblioteca"  data-url="<?php echo base_url(); ?>biblioteca/list?mode=select_multiple&type=images&field=imagenes" data-toggle="modal"> <i class="fa fa-plus"></i> <span> Abrir Biblioteca </span> </a>
