                        	...
                        	<div class="item clearfix margin-bottom-25">
                                ...
                                <div class="col-md-2 text-center">
                                    <label class="mt-checkbox mt-checkbox-outline">
                                        ...
                                        <span></span>
                                        <img src="<?=base_url()?>assets/images/ejemplos/thumb.jpg">
                                    </label>
                                </div>
                                <div class="col-md-8">
                                	<div class="form-group">
                                    	<div class="row">
                                            <div class="col-md-10">xcab1_2pagespeeddic-II.jpg</div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="nombre" class="form-control grey-silver" value="xcab1_2pagespeeddic-II">
                                    </div>
                                    <div class="form-group">
                        	...
                        	<div class="item clearfix margin-bottom-25">
                                ...
                                <div class="col-md-2 text-center">
                                    <label class="mt-checkbox mt-checkbox-outline">
                                        <input type="checkbox" value="1" name="item" />
                                        <span></span>
                                        <div class="img margin-bottom-5">
                                            <img src="<?=base_url()?>assets/images/ejemplos/thumb.jpg">
                                            <i class="icon-control-play"></i>
                                        </div>
                                        <a href="#" class="underline grey btn-sm">añadir miniatura</a>
                                    </label>
                                </div>
                                <div class="col-md-8">
                                	<div class="form-group">
