...
<?php endif; ?>
  ...
  <div class="mt-radio-inline">
    ...
    <input type="radio" data-description="<?php  echo @$LS[$ffile][$field_name][$display."_description"]; ?>" name="<?php echo $field_name; ?>" <?php if (@$x_estado == "1") { ?> checked<?php } ?> value="<?php echo $value; ?>" <?php if ($value==@$default): ?> checked <?php endif; ?>>
  ...
  <div class="note note-info" id="ShowDescription"></div>
  </div>
