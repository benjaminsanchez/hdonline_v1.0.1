...
<div class="form-group" id="Show_<?php echo $field_name; ?>">
  ...
  <div class="col-md-<?php echo $sizerow[1]; ?>">
    <input type="hidden" name="<?php echo $field_name; ?>" id="<?php echo $field_name; ?>" size="20" class="imageinput" value="<?php echo htmlspecialchars(@$default) ?>"  <?php echo @$required; ?>>   
     ...
     <a href="#" data-url="<?php echo base_url(); ?>biblioteca/list?mode=select&field=<?php echo $field_name; ?>&type=<?php echo @$extra; ?>" data-toggle="modal" class="btn blue pull-left biblioteca"><i class="fa fa-search"></i> &nbsp;Examinar</a>
    <div class="preview-biblioteca" id="ShowPreview<?php echo $field_name; ?>">
    </div>
 </div>
