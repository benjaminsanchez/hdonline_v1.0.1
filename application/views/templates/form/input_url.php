...
<?php endif; ?>
  ...
  <div class="col-md-<?php echo $sizerow[1]; ?>">
    <input type="url" name="<?php echo $field_name; ?>" id="<?php echo $field_name; ?>" class="form-control" size="30"  <?php if (@$maxlength>0): ?> maxlength="<?php echo @$maxlength; ?>" <?php endif; ?>  value="<?php echo htmlspecialchars(@$default) ?>" <?php echo @$required; ?>>
  </div>
