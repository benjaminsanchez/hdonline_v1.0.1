...
if ($Data2):
	foreach ($Data2 as $row):
		...
		$detalle[$row["id_referencia"]]["nombre"] = getField("nombre",$row["tabla"]." WHERE id_coleccion = '".$row["id_referencia"]."' ",$conn);
	endforeach; 
endif; 

?>
<!-- start:  BLOQUE COLECCIONES -->

<div class="portlet light">
  <div class="portlet-title">
    <div class="caption"> <i class="icolist font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Interacciones generadas en Colecciones</span> <span class="caption-helper"><?php echo @$LS["list_help"]; ?></span> </div>
    <?php if ($sExport == "") { ?>
    <div class="actions">
      <div class="btn-group"> <a class="btn btn-default btn-circle" href="<?php echo base_url(); ?>dashboard/colecciones/excel" > <i class="fa fa-share"></i> <?php echo $LS["ExportToExcel"]; ?> </a>
      </div>
    </div>
    <?php } ?>
  </div>
  <div class="portlet-body"> 
    ...
    <div class="table-container">
      <div id="datatable_products_wrapper" class="dataTables_wrapper dataTables_extended_wrapper no-footer"> 
              ...
              <table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_products" aria-describedby="datatable_products_info" role="grid">
                <thead>
                  <tr role="row" class="heading">
                    ...
                    <?php if (count(@$TE[$seccion])>0): foreach (@$TE[$seccion] as $data): ?>
        ...
        <div class="portlet-title">
          <div class="caption"> <i class="icolist font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Listado de colecciones</span> <span class="caption-helper"><?php echo @$LS["list_help"]; ?></span> </div>
        </div>
        ...
        <div class="table-scrollable">
          <div class="col-md-12 col-sm-12 tcenter">
            <div class="dataTables_length" id="datatable_products_length">
              <button class="btn btn-sm btn-circle green-sharp table-group-action-submit"  onclick="document.location.href='dashboard/colecciones'" > Ver todos </button>
            </div>
          </div>
        </div>
        <?php endif; ?>
